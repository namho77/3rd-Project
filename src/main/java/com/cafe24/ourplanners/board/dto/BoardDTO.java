...
public class BoardDTO {
	...
	public java.sql.Date getContact_time_start() {
		return contact_time_start;
	}
	public void setContact_time_start(java.sql.Date contact_time_start) {
		this.contact_time_start = contact_time_start;
	}
	public java.sql.Date getContact_time_end() {
		return contact_time_end;
	}
	public void setContact_time_end(java.sql.Date contact_time_end) {
		this.contact_time_end = contact_time_end;
	}
	...
	public char getService_expired() {
		return service_expired;
	}
	public void setService_expired(char service_expired) {
		this.service_expired = service_expired;
	}
