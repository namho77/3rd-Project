...
public class BoardVO {
	...
	public BoardVO(int board_srl, String user_id, String location, Date service_time_start, Date service_time_end,
			String title, String contents, Date postdate, int visitcount, int contact_time_start, int contact_time_end,
			String like_user_id, String main_image, String contents_image, int category_srl, int subcategory_srl,
			String service_expired, int service_cost, int limit_person, String board_type, int service_score,
			Date last_update) {
