...
public class PagingUtil {
	...
	public static String pagingImg(int totalRecordCount, int pageSize, int blockPage, int nowPage, String page) {
		...
		if (intTemp != 1) { 
			...
			pagingStr += "<li><a href='" + page + "nowPage=1'> <span class=\"glyphicon glyphicon-backward\"></span></a></li>";
		...
		if (intTemp <= totalPage) {
			pagingStr += "<li><a href='" + page + "nowPage=" + intTemp + "'>" + "<span class=\"glyphicon glyphicon-chevron-right\"></span></a></li>";

			pagingStr += "<li><a href='" + page + "nowPage=" + totalPage + "'>" + "<span class=\"glyphicon	glyphicon-forward\"></span></a></li>";
	...
	public static String pagingAjax(int totalRecordCount, int pageSize, int blockPage, int nowPage, String page) {
		...
		// 다음 및 마지막 페이지를 위한 로직
		if (intTemp <= totalPage) {
			pagingStr += "<li><a href='javascript:paging("+intTemp+");'>" + "<span class=\"glyphicon glyphicon-chevron-right\"></span></a></li>";

			pagingStr += "<li><a href='javascript:paging("+totalPage+");'>" + "<span class=\"glyphicon	glyphicon-forward\"></span></a></li>";
	...
	public static String pagingAjax2(int totalRecordCount, int pageSize, int blockPage, int nowPage, String jsFnName) {
		...
		if (intTemp != 1) { 
			...
			pagingStr += "<li><a href='javascript:"+jsFnName+"(1);'> <span class=\"glyphicon glyphicon-backward\"></span></a></li>";
		...
		// 다음 및 마지막 페이지를 위한 로직
		if (intTemp <= totalPage) {
			pagingStr += "<li><a href='javascript:"+jsFnName+"("+intTemp+");'>" + "<span class=\"glyphicon glyphicon-chevron-right\"></span></a></li>";

			pagingStr += "<li><a href='javascript:"+jsFnName+"("+totalPage+");'>" + "<span class=\"glyphicon	glyphicon-forward\"></span></a></li>";
	...
	public static String pagingAjaxFAQ(int totalRecordCount, SearchFAQCriteria scri, String jsFnName) {
		...
		if (intTemp != 1) { 
			...
			pagingStr += "<li><a href='javascript:"+jsFnName+"(1,"+service_srl+","+category_srl+");'> <span class=\"glyphicon glyphicon-backward\"></span></a></li>";
			
			
			//블럭 페이지의 마지막 페이지 번호로
			pagingStr += "<li><a href='javascript:"+jsFnName+"("+ (intTemp - 1) +","+service_srl+","+category_srl+ ");'>"
			//블럭 페이지의 첫번째 페이지번호로
			//pagingStr += "<li><a href='javascript:paging("+(intTemp - blockPage) + ");'>"
					+ "<span class=\"glyphicon glyphicon-chevron-left\"></span></a></li>";
		}
		...
		while (blockCount <= blockPage && intTemp <= totalPage) {
			...
			if (intTemp == nowPage) {
				...
				pagingStr += "<li><a href='javascript:"+jsFnName+"("+intTemp+","+service_srl+","+category_srl+");'>" + intTemp + "</a></li>";
			}
		...
		// 다음 및 마지막 페이지를 위한 로직
		if (intTemp <= totalPage) {
			pagingStr += "<li><a href='javascript:"+jsFnName+"("+intTemp+","+service_srl+","+category_srl+");'>" + "<span class=\"glyphicon glyphicon-chevron-right\"></span></a></li>";

			pagingStr += "<li><a href='javascript:"+jsFnName+"("+totalPage+","+service_srl+","+category_srl+");'>" + "<span class=\"glyphicon	glyphicon-forward\"></span></a></li>";
