						...
						<div class="panel panel-default">
							<div class="panel-body padding-all-0 overflow-hidden border-solid">
								<div class="text-style">
									<iframe src="https://docs.google.com/document/d/1SYVep0erRiv0AAUgKuRqkYzvPGOJ0Q-8Ux7BW4l77eQ/pub?embedded=true" width="100%" style="height: 6200px;" border="0"></iframe>
								</div>
							</div>
						</div>
					</div>
