...
<script>
	...
	var url="${pageContext.request.contextPath}/board/json/top_search_list.json";
		...
		var params="board_type=E&pageSize=5&blockPage=1&keyword=&searchType=tc";  
			...
			<div class="container">
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<h2 class="section-title st2 mb25">추천 서비스</h2>
						<div class="text-center">
							<p class="mb0">추천 서비스 입니다.</p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-sm-7 col-md-9 col-md-push-3 col-sm-push-5 space-left push-off">
						...
						<div class="col-sm-6 col-md-3">
							<div class="blog-item">
								<div class="blog-image">
									<img src="../assets/images/demo/p-225.jpg" alt="blog post">
								</div>
						...
						<div class="col-sm-6 col-md-3">
							<div class="blog-item">
								<div class="blog-image">
									<img src="../assets/images/demo/p-224.jpg" alt="blog post">
								</div>
								<div class="blog-caption">
						...
						<div class="col-sm-6 col-md-3">
							<div class="blog-item">
								<div class="blog-image">
									<img src="../assets/images/demo/p-204.jpg" alt="blog post">
								</div>
								<div class="blog-caption">
						...
						<div class="col-sm-6 col-md-3">
							<div class="blog-item">
								<div class="blog-image">
									<img src="../assets/images/demo/p-203.jpg" alt="blog post">
								</div>
								<div class="blog-caption">
					...
					<div class="col-sm-5 col-md-3 col-md-pull-9 col-sm-pull-7 pull-off">
						<aside class="sidebar">
								...
								<div class="tab-content">
										...
										<ul class="latest-posts">
											<li>
												<div class="image-post">
													<img src="../assets/images/demo/p-101.jpg" alt="blog post">
												</div>
												<div class="info-post">
													<h5>
											...
											<li>
												<div class="image-post">
													<img src="../assets/images/demo/p-102.jpg" alt="blog post">
												</div>
												<div class="info-post">
													<h5>
											...
											<li>
												<div class="image-post">
													<img src="../assets/images/demo/p-103.jpg" alt="blog post">
												</div>
												<div class="info-post">
													<h5>
									...
									<div class="tab-pane fade" id="tab2">
										<ul class="latest-posts">
											<li>
												<div class="image-post">
													<img src="../assets/images/demo/p-104.jpg" alt="blog post">
												</div>
												<div class="info-post">
													<h5>
											...
											<li>
												<div class="image-post">
													<img src="../assets/images/demo/p-105.jpg" alt="blog post">
												</div>
												<div class="info-post">
													<h5>
											...
											<li>
												<div class="image-post">
													<img src="../assets/images/demo/p-106.jpg" alt="blog post">
												</div>
												<div class="info-post">
													<h5>
							...
							<div class="sidebar-widget">
								<h3 class="sidebar-title mb30">Categories</h3>
								<ul class="categories">
