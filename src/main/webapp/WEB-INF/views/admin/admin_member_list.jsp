		...
		$.ajax({
			...
			success : function(data) {
				$.each(data.memberLists, function(index, memberObj) { // each로 모든 데이터 가져와서 items 배열에 넣고
					...
					inHTML += "<tr>";
					inHTML += "<td class=\"\">";
					inHTML += "	<input type=\"checkbox\" class=\"memberIds\" id=\"memberIds\" name=\"memberIds\" value=\""+memberObj.user_id+"\" />";
					inHTML += "</td>";
					inHTML += "<td class=\"\">";
					inHTML += "" + memberObj.user_id + "";
					inHTML += "</td>";
					inHTML += "<td class=\"\">";
					inHTML += "" + memberObj.user_name + "";
					inHTML += "</td>";
					inHTML += "<td class=\"\">";
					inHTML += "" + memberObj.email_address + "";
					inHTML += "</td>";
					inHTML += "<td class=\"\">";
