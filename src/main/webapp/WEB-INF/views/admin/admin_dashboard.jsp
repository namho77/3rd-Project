				...
				<ul class="sidebar-nav">
					...
					<li><a href="#"><i class="glyph-icon flaticon-account"></i><span class="sidebar-text">관리자 계정 관리</span><span class="fa arrow"></span></a>
						<ul class="submenu collapse">
							<li><a href="profil.html"><span class="sidebar-text">나의 정보 보기</span></a></li>
							<li><a href="profil_edit.html"><span class="sidebar-text">나의 정보 수정</span></a></li>
					...
					<li><a href="#"><i class="glyph-icon flaticon-email"></i><span class="sidebar-text">메시지</span><span class="fa arrow"></span></a>
						<ul class="submenu collapse">
							...
							<li><a href="${pageContext.request.contextPath}/customercenter/email"><span class="sidebar-text">이메일 작성</span></a></li>
						</ul></li>
						
					<li class="m-b-245"><a href="charts.html"><i class="glyph-icon flaticon-charts2"></i><span class="sidebar-text">차트 보기</span><span class="pull-right label label-primary">6</span></a></li>
